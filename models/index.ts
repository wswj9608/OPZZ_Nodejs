...
export const selectItems =
  "SELECT distinct(icon_id), item_icon.item_id, image_url, file_name, name, description, gold_total FROM item_icon join item_info on item_icon.item_id = item_info.item_id WHERE item_icon.item_id = 1004;"
